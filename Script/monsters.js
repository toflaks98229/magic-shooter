...
/**
 * @description 제 그림을 가진 몬스터들.
 *
 * Data/tiles/monsters_data.json 에서 뽑았습니다. 손으로 고치지 마세요.
 * 목록이 바뀌면 tools/build-monster-atlas.js 를 다시 돌리십시오.
 */
const MONSTER_SPRITES = new Set(["abomination-large","abomination-small","acid-blob","acid-dragon","adder","agnes","air-elemental","aizul","alderking","alligator","alligator-snapping-turtle","amaemon","anaconda","ancestor","ancestor-battlemage","ancestor-hexer","ancestor-knight","ancient-champion","ancient-lich","ancient-zyme","angel","antique-champion","apis","apocalypse-crab","arachne","arcanist","armataur","armour-echo","aspiring-flesh","asterion","azrael","azure-jelly","ball-lightning","ball-python","ballistomycete","ballistomycete-spore","balrug","barachi","basilisk","bat","battlesphere","bennu","black-bear","black-mamba","blazeheart-core","blazeheart-golem","blink-frog","blizzard-demon","bloated-husk","block-of-ice","bog-body","boggart","bombardier-beetle","bomblet","bone-dragon","boris","boulder","boulder-beetle","brain-worm","briar-patch","brimstone-fiend","broodmother","bullfrog","bunyip","burial-acolyte","burstshroom","bush","butterfly","cacodemon","cactus-giant","cane-toad","cassandra","catoblepas","caustic-shrike","caustic-sporangium","centaur","centaur-warrior","cerulean-imp","chaos-spawn","cherub","chonchon","chuck","clockroach","clockwork-bee","cloud-mage","cognitogaunt","colossal-amoeba","crawling-flesh-cage","crazy-yiuf","creeping-inferno","creeping-plasmodium","crimson-imp","crocodile","crystal-echidna","crystal-guardian","crystal-tome","culicivora","curse-skull","curse-toe","cyclops","daeva","dart-slug","death-cob","death-drake","death-knight","death-scarab","death-yak","deathcap","deep-elf-annihilator","deep-elf-archer","deep-elf-blademaster","deep-elf-death-mage","deep-elf-demonologist","deep-elf-elementalist","deep-elf-high-priest","deep-elf-knight","deep-elf-master-archer","deep-elf-sorcerer","deep-troll","deep-troll-earth-mage","deep-troll-shaman","demigod","demonic-crawler","demonspawn","diamond-sawblade","dissolution","divine-tome","donald","dowan","dread-lich","dream-sheep","drowned-soul","drude","dryad","duvessa","dwarf","earth-elemental","earthen-tome","edmund","efreet","eidolon","eldritch-tentacle","electric-eel","electric-golem","eleionoma","elephant","elephant-slug","elf","emperor-scorpion","enchantress","endoplasm","entropy-weaver","erica","erolcha","erythrospite","ettin","eustachio","executioner","eye-of-devastation","eye-of-draining","fannar","faun","fenstrider-witch","fire-bat","fire-crab","fire-dragon","fire-elemental","fire-giant","fire-vortex","flayed-ghost","formicid","foxfire","frances","fravashi","frederick","freezing-wraith","frilled-lizard","frost-giant","frostbound-tome","fulminant-prism","fungus","gargoyle","gastronok","geryon","ghost","ghost-crab","ghost-moth","ghoul","glass-eye","glowing-orange-brain","glowing-shapeshifter","gnoll","gnoll-sergeant","goblin","goblin-rider","golden-dragon","golden-eye","goliath-frog","great-orb-of-eyes","green-death","grinder","grum","grunn","guardian-mummy","guardian-serpent","guardian-sphinx","halazid-warlock","halfling","harold","harpy","hell-hog","hell-hound","hell-knight","hell-sentinel","hellbinder","hellfire-mortar","hellion","hellwing","hippogriff","hoarfrost-cannon","hobgoblin","hog","holy-swine","hornet","hound","human","hydra","ice-beast","ice-devil","ice-dragon","ice-fiend","ice-statue","ignacio","iguana","ijyb","ilsuiw","imperial-myrmidon","inugami","iron-dragon","iron-elemental","iron-giant","iron-golem","iron-imp","iron-troll","ironbound-beastmaster","ironbound-convoker","ironbound-frostheart","ironbound-mechanist","ironbound-preserver","ironbound-thunderhulk","jackal","jelly","jeremiah","jessica","jiangshi","jorgrun","jorogumo","jory","joseph","josephina","josephine","juggernaut","jumping-spider","khufu","killer-bee","kirke","kobold","kobold-blastminer","kobold-brigand","kobold-demonologist","kobold-fleshcrafter","kobold-geomancer","komodo-dragon","kraken-tentacle","laughing-skull","lava-snake","lemure","lich","lightning-spire","lindwurm","living-spell","lodul","lost-soul","louise","lurking-horror","maggie","mana-viper","manticore","mara","margery","marrowcuda","martyred-shade","maurice","meliai","menkaure","mennas","merfolk","merfolk-aquamancer","merfolk-avatar","merfolk-impaler","merfolk-javelineer","merfolk-siren","meteoran","minotaur","mlioglotl","molten-gargoyle","monarch-bomb","moon-troll","morphogenic-ooze","moth-of-wrath","mountainshell","mummy","mummy-priest","murray","naga","naga-mage","naga-ritualist","naga-sharpshooter","naga-warrior","nagaraja","nargun","nascent-plasmodium","natasha","necromancer","necrophage","nekomata","nellie","neqoxec","nergalle","nessos","nikola","norris","oblivion-hound","obsidian-bat","obsidian-statue","occultist","octopode","ogre","ogre-mage","oklob-plant","oklob-sapling","oni","oni-incarcerator","ophan","orange-demon","orb-guardian","orb-of-destruction","orb-of-entropy","orb-of-fire","orb-of-winter","orb-spider","orc","orc-high-priest","orc-knight","orc-priest","orc-sorcerer","orc-warlord","orc-warrior","orc-wizard","pandemonium-lord","pargi","peacekeeper","pearl-dragon","petrified-flower","phalanx-beetle","phantasmal-warrior","phantom","pharaoh-ant","pikel","pile-of-debris","pile-of-flesh","pillar-of-salt","plant","platinum-paragon","player-shadow","polar-bear","poltergeist","polterguardian","polyphemus","prince-ribbit","profane-servitor","protean-progenitor","putrid-mouth","queen-bee","quicksilver-dragon","quicksilver-elemental","quokka","radroach","ragged-hierophant","raiju","rakshasa","rat","raven","reaper","red-devil","redback","rending-blade","revenant","revenant-soulmonger","ribbon-worm","rime-drake","robin","rock-fish","rockslime","roxanne","royal-mummy","rupert","rust-devil","sacred-lotus","saint-roka","salamander","salamander-mystic","salamander-tyrant","saltling","satyr","scorpion","screaming-refraction","scrub-nettle","sea-snake","searing-wretch","seismosaurus","servant-of-whispers","shadow-demon","shadow-dragon","shadow-imp","shadow-prism","shadow-puppet","shadow-turret","shadow-wraith","shadowghast","shapeshifter","shard-shrike","shining-eye","shock-serpent","shooting-star","sigmund","silent-spectre","sin-beast","sixfirhy","skeletal-warrior","sky-beast","skyshark","sleepcap","slime-creature","slymdra","smoke-demon","snapping-turtle","snorg","sojobo","solar-ember","sonja","soul-eater","soul-wisp","spark-wasp","spatial-vortex","spellspark-servitor","sphinx-marauder","splinterfrost-barricade","spriggan","spriggan-air-mage","spriggan-berserker","spriggan-defender","spriggan-druid","spriggan-rider","sprozz","star-jelly","starcursed-mass","starflower","steam-dragon","steelbarb-worm","stoker","stone-giant","storm-dragon","sun-demon","sun-moth","swamp-dragon","swamp-drake","swamp-worm","tainted-leviathan","tarantella","tengu","tengu-conjurer","tengu-reaver","tengu-warrior","tentacled-monstrosity","tentacled-starspawn","terence","thermic-dynamo","thorn-hunter","thrashing-horror","titan","toenail-golem","tormentor","torpor-snail","training-dummy","troll","twister","two-headed-ogre","tyrant-leech","tzitzimitl","ufetubus","ugly-thing","undertaker","undying-armoury","unseen-horror","urug","ushabti","vampire","vampire-bat","vampire-bloodprince","vampire-knight","vampire-mage","vampire-mosquito","vashnia","vault-guard","vault-sentinel","vault-warden","very-ugly-thing","vine-stalker","void-ooze","vv","walking-alembic","wandering-mushroom","war-gargoyle","warg","water-elemental","water-moccasin","water-nymph","weeping-skull","wendigo","white-imp","wight","wiglaf","will-o-the-wisp","wind-drake","withered-plant","wolf","wolf-spider","worldbinder","wraith","wretched-star","wyrmhole","wyvern","xakkrixis","xtahua","yak","yaktaur","yaktaur-captain","ynoxinul","zenata","zykzyl"]);
/**
 * 몬스터에게 붙일 그림을 고릅니다.
 *
...
function pickSprite(data) {
    // 종마다의 그림이 있으면 그것을 씁니다.
    //
    // 아래의 이름표와 글리프표는 그림이 마흔세 개뿐이던 시절의 것입니다.
    // 이제 원본에서 뽑은 오백쉰한 종이 제 그림을 가지므로, 그 표들은
    // 나머지를 덮는 대체가 되었습니다.
    if (MONSTER_SPRITES.has(data.id)) return `mon_${data.id}`;
