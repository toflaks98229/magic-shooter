...
export const BRANCHES = {
    ...
    T: {
        ...
        monsters: ['zombie', 'skeleton', 'imp', 'phantasmal'],
    },
    L: {
        id: 'L', name: '짐승굴', parent: 'D',
        entryFrom: 8, entryTo: 11, depth: 5, rune: false,
        theme: 'cave', themeVariation: 1,
        monsters: ['beast', 'spider', 'snake', 'frog', 'crocodile', 'killer_bee', 'hydra'],
    },
    S: {
        ...
        monsters: ['crocodile', 'frog', 'snake', 'hydra', 'jelly'],
    },
    A: {
        ...
        theme: 'cave', themeVariation: 2,
        exclusiveGroup: 'lair-wet',
        monsters: ['merfolk', 'crocodile', 'centaur', 'hydra'],
    },
    P: {
        ...
        monsters: ['naga', 'snake', 'mana_viper', 'hydra'],
    },
    N: {
    ...
    U: {
        ...
        monsters: ['hell_knight', 'demon', 'gargoyle', 'stone_giant', 'golem'],
    },
    H: {
        id: 'H', name: '지옥의 안뜰', parent: 'U',
        entryFrom: 1, entryTo: 4, depth: 1, rune: false,
        theme: 'hell', themeVariation: 1,
        monsters: ['imp', 'fire_demon', 'hell_knight', 'cacodemon'],
    },
    X: {
        id: 'X', name: '코키투스', parent: 'H',
        entryFrom: 1, entryTo: 1, depth: 7, rune: true,
        theme: 'ice', themeVariation: 1,
        monsters: ['ice_giant', 'ice_dragon', 'simulacrum', 'ice_beast'],
    },
    G: {
        id: 'G', name: '게헨나', parent: 'H',
        entryFrom: 1, entryTo: 1, depth: 7, rune: true,
        theme: 'hell', themeVariation: 1,
        monsters: ['fire_demon', 'fire_giant', 'hell_knight', 'gargoyle'],
    },
    Y: {
        id: 'Y', name: '타르타로스', parent: 'H',
        entryFrom: 1, entryTo: 1, depth: 7, rune: true,
        theme: 'crypt', themeVariation: 2,
        monsters: ['spectre', 'phantasmal', 'cacodemon', 'mummy'],
    },
    I: {
        id: 'I', name: '철의 도시 디스', parent: 'H',
        entryFrom: 1, entryTo: 1, depth: 7, rune: true,
        theme: 'hell', themeVariation: 2,
        monsters: ['hell_knight', 'golem', 'demon', 'gargoyle'],
    },
    Z: {
        id: 'Z', name: '조트의 왕국', parent: 'U',
        entryFrom: 5, entryTo: 5, depth: 5, rune: true,
        theme: 'hell', themeVariation: 2,
        monsters: ['demon', 'hell_knight', 'ice_dragon', 'golem', 'cacodemon'],
    },
};
