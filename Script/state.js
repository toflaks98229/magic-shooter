...
/** @description 오브젝트 맵 데이터를 새로운 맵으로 교체하는 함수 */
export function setObjectMap(newObjectMap) { objectMap = newObjectMap; }
...
/** @description 스프라이트로 렌더링되는 동적 오브젝트의 애니메이션 상태를 저장하는 배열 (예: 폭발 효과) */
export let animatedObjects = [];
/**
 * @description 벽처럼 렌더링되는 동적 오브젝트(예: 열리는 문)의 애니메이션 상태를 저장하는 배열.
 * gameLogic.js에서 상태를 업데이트하고 render.js의 renderWorld에서 렌더링에 사용합니다.
 */
export let animatedWalls = [];
