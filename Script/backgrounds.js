...
export const BACKGROUNDS = {
    fighter: {
        ...
        recommended: ['mountain-dwarf', 'troll', 'minotaur', 'gargoyle', 'armataur', 'formicid', 'revenant'],
    },
    gladiator: {
        ...
        recommended: ['mountain-dwarf', 'merfolk', 'minotaur', 'gargoyle', 'coglin', 'vine-stalker'],
    },
    monk: {
        ...
        recommended: ['mountain-dwarf', 'troll', 'armataur', 'merfolk', 'gargoyle', 'demonspawn'],
    },
    berserker: {
        ...
        recommended: ['mountain-dwarf', 'oni', 'merfolk', 'minotaur', 'gargoyle', 'armataur'],
    ...
    chaosKnight: {
        ...
        recommended: ['spriggan', 'troll', 'gnoll', 'merfolk', 'minotaur', 'draconian-base', 'demonspawn'],
    ...
    cinderAcolyte: {
        ...
        recommended: ['mountain-dwarf', 'draconian-base', 'oni', 'djinni', 'gnoll'],
    },
    reaver: {
        ...
        recommended: ['gnoll', 'tengu', 'barachi', 'demonspawn', 'draconian-base', 'mountain-dwarf'],
    },
    shapeshifter: {
        ...
        recommended: ['naga', 'merfolk', 'draconian-base', 'demigod', 'demonspawn', 'troll'],
    },
    hunter: {
    ...
    brigand: {
        ...
        recommended: ['troll', 'spriggan', 'demonspawn', 'vine-stalker', 'gnoll'],
    },
    artificer: {
        ...
        recommended: ['kobold', 'spriggan', 'draconian-base', 'demonspawn', 'coglin'],
    },
    delver: {
    ...
    warper: {
        ...
        recommended: ['felid', 'spriggan', 'armataur', 'draconian-base', 'coglin'],
    },
    hexslinger: {
        ...
        recommended: ['formicid', 'deep-elf', 'kobold', 'spriggan', 'gnoll'],
    },
    hedgeWizard: {
        ...
        recommended: ['deep-elf', 'naga', 'draconian-base', 'octopode', 'human', 'djinni'],
    },
    conjurer: {
        ...
        recommended: ['deep-elf', 'naga', 'tengu', 'draconian-base', 'demigod', 'djinni', 'armataur'],
    },
    summoner: {
        ...
        weapon: 'gun', items: ['magic'],
        sourceEquipment: ['robe', 'potion of magic'],
        recommended: ['deep-elf', 'oni', 'vine-stalker', 'merfolk', 'tengu'],
    },
    necromancer: {
        ...
        recommended: ['deep-elf', 'djinni', 'mountain-dwarf', 'demonspawn', 'mummy', 'revenant'],
    },
    forgewright: {
        ...
        recommended: ['mountain-dwarf', 'coglin', 'barachi', 'human', 'vine-stalker', 'merfolk'],
    },
    enchanter: {
        ...
        recommended: ['deep-elf', 'felid', 'kobold', 'spriggan', 'naga', 'poltergeist'],
    },
    fireElementalist: {
        ...
        weapon: 'gun', items: ['magic'],
        sourceEquipment: ['robe', 'potion of magic'],
        recommended: ['deep-elf', 'mountain-dwarf', 'naga', 'tengu', 'demigod', 'gargoyle', 'djinni'],
    },
    iceElementalist: {
        ...
        weapon: 'gun', items: ['magic'],
        sourceEquipment: ['robe', 'potion of magic'],
        recommended: ['merfolk', 'barachi', 'draconian-base', 'demigod', 'gargoyle', 'djinni', 'revenant'],
    },
    airElementalist: {
        ...
        weapon: 'gun', items: ['magic'],
        sourceEquipment: ['robe', 'potion of magic'],
        recommended: ['deep-elf', 'tengu', 'draconian-base', 'naga', 'vine-stalker', 'djinni'],
    },
    earthElementalist: {
        ...
        weapon: 'gun', items: ['magic'],
        sourceEquipment: ['robe', 'potion of magic'],
        recommended: ['deep-elf', 'spriggan', 'gargoyle', 'demigod', 'octopode', 'revenant'],
    },
    alchemist: {
        ...
        sourceEquipment: ['robe', 'potion of magic'],
        recommended: ['deep-elf', 'spriggan', 'naga', 'merfolk', 'octopode', 'djinni', 'demonspawn'],
    },
    wanderer: {
        ...
        weapon: 'gun', items: [],
        sourceEquipment: [],
        recommended: ['mountain-dwarf', 'gnoll', 'merfolk', 'draconian-base', 'human', 'demonspawn', 'barachi'],
